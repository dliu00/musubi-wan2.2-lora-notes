...
accelerate launch \
  ...
  --task i2v-A14B \
  --dit /root/workspace/musubi-tuner/train_models/split_files/diffusion_models/wan2.2_i2v_low_noise_14B_fp16.safetensors \
...
accelerate launch \
  ...
  src/musubi_tuner/wan_train_network.py \
  --task i2v-A14B \
  --dit /root/workspace/musubi-tuner/train_models/split_files/diffusion_models/wan2.2_i2v_high_noise_14B_fp16.safetensors \
  --vae /root/ai-models/Wan-AI/Wan2.2-I2V-A14B/Wan2.1_VAE.pth \
  --t5 /root/ai-models/Wan-AI/Wan2.2-I2V-A14B/models_t5_umt5-xxl-enc-bf16.pth \
  --dataset_config dataset.toml \
  --sdpa \
